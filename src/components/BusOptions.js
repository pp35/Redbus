          ...
          {busData.map((bus, index) => (
            <div key={index} className="flex justify-between mb-4 p-4">
              ...
              <div className="flex flex-col justify-between items-end max-h-4">
                ...
                <div className=" mt-2">
                  <button onClick={() => handleViewSeats(index)} className="inline-flex items-center justify-center whitespace-nowrap ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-primary/90 h-10 text-xs font-medium bg-green-500 text-white px-2 py-1 rounded">
